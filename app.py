...
def gerar_template():
    try:
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            # --- ADICIONAR INSTRUÇÕES MELHORADAS NA ABA "Como Usar" ---
            instructions_data = [
                ['📋 GUIA DE USO - PLANILHA DE OTIMIZAÇÃO DE CDs', ''],
                ['', ''],
                ['📚 ÍNDICE RÁPIDO - NAVEGAÇÃO', 'Clique na célula e use Ctrl+Seta para ir diretamente'],
                ['• 🎯 Objetivo do Modelo', 'Linha 13'],
                ['• 📝 Passo a Passo Detalhado', 'Linha 15'],
                ['• 📊 Exemplos Práticos Visuais', 'Linha 32'],
                ['• ✅ Checklist de Validação', 'Linha 45'],
                ['• ⚡ Dicas Rápidas', 'Linha 53'],
                ['• ❓ Perguntas Frequentes', 'Linha 60'],
                ['• 🛠️ Troubleshooting', 'Linha 92'],
                ['• 🚀 Próximos Passos', 'Linha 98'],
                ['', ''],
                ...
                ['', ''],
                ['📊 EXEMPLO PRÁTICO - TABELA VISUAL:', ''],
                ['CD Cliente1 Cliente2 Cliente3 CustoFixo Capacidade', ''],
                ['CD1_SP 5.50 8.20 3.75 15000 1000', ''],
                ['CD2_RJ 7.30 4.10 6.85 12000 800', ''],
                ['Demanda 300 450 250', ''],
                ['', ''],
                [' Valores acima:', 'R$/unidade de transporte'],
                ...
                ['', ''],
                [' CHECKLIST ANTES DO UPLOAD:', 'Marque itens conforme verifica'],
                [' Matriz completa (sem células vazias)', 'Verifique todas as células cinzas'],
                [' Todos os valores são números positivos', 'Use apenas ponto decimal ou vírgula'],
                [' Capacidade total ≥ Demanda total', 'Soma capacidades ≥ soma demandas'],
                [' Coordenadas em formato decimal (se usadas)', 'Ex: -23.5505, -46.6333 ou -23,5505, -46,6333'],
                [' Arquivo salvo como .xlsx', 'Formato Excel correto'],
                [' Sem formatação nos números', 'Ex: 15000, não R$ 15.000'],
                ['□ Coordenadas em formato decimal (se usadas)', 'Ex: -23.5505, -46.6333 ou -23,5505, -46,6333'],
                ['□ Arquivo salvo como .xlsx', 'Formato Excel correto'],
                ['□ Sem formatação nos números', 'Ex: 15000, não R$ 15.000'],
                ['', ''],
                ['⚡ DICAS RÁPIDAS - ATALHOS DO EXCEL:', ''],
                ['• Copiar/Colar: Ctrl+Drag para células adjacentes', 'Preenche rapidamente'],
                ['• Validação: F5 > Especial > Constantes', 'Encontra células com erros'],
                ['• Formatação: Ctrl+Shift+1 para números', 'Remove formatação'],
                ['• Navegação: Ctrl+Setas para mover rápido', 'Salta entre dados'],
                ['• Seleção: Ctrl+Espaço seleciona coluna', 'Atalho útil'],
                ['', ''],
                ['❓ PERGUNTAS FREQUENTES (FAQ):', ''],
                ['Q: Posso usar vírgula nos números?', 'A: Não, use apenas ponto decimal (5.50, não 5,50)'],
                ['Q: O que fazer se der erro de capacidade?', 'A: Aumente capacidade dos CDs ou reduza demanda total'],
                ['Q: Coordenadas são obrigatórias?', 'A: Não, mas recomendadas para mapas interativos'],
                ['Q: Como testar se está correto?', 'A: Use o checklist acima e validador online'],
                ['Q: Posso deixar células em branco?', 'A: Não, todas devem ter valores numéricos'],
                ['', ''],
                ['📈 SEU PROGRESSO:', 'Status atual do preenchimento'],
                ['▓▓▓▓▓▓▓▓▓░ 90% - Quase pronto!', ''],
                ['✅ Dados básicos preenchidos', ''],
                ['✅ Validações verificadas', ''],
                ['⏳ Aguardando upload no sistema', ''],
                ['', ''],
                ['📖 GLOSSÁRIO RÁPIDO:', 'Termos importantes'],
                ['CD: Centro de Distribuição', ''],
                ['Demanda: Quantidade necessária por cliente', ''],
                ['Custo Fixo: Custo mensal para operar CD', ''],
                ['Capacidade: Limite máximo de atendimento', ''],
                ['Matriz: Tabela de custos de transporte', ''],
                ['', ''],
                ['📊 MÉTRICAS ESPERADAS:', 'Resultados que você obterá'],
                ['• Economia estimada: 15-30%', 'Nos custos logísticos totais'],
                ['• Tempo de processamento: < 2 min', 'Para resolver o problema'],
                ['• Precisão da solução: > 99%', 'Garantia de otimalidade'],
                ['• Relatórios gerados: 3 tipos', 'Mapas, estatísticas e recomendações'],
                ['', ''],
                ...
                ['• Solução não encontrada', 'Verifique se dados são realistas e completos'],
                ['• Processamento muito lento', 'Reduza número de CDs ou clientes'],
                ['', ''],
                ['🚀 PRÓXIMOS PASSOS:', ''],
                ['1. Preencha todos os dados na aba "Localização"', ''],
                ['2. Use o checklist para validar (linha 40)', ''],
                ['3. Opcional: Preencha coordenadas na aba "Coordenadas_CDs"', ''],
                ['4. Salve o arquivo Excel (.xlsx)', ''],
                ['5. Faça upload no sistema', ''],
                ['6. Aguarde o resultado da otimização', ''],
                ['7. Se usou coordenadas, visualize o mapa interativo nos resultados', ''],
                ['', ''],
                ['Parâmetros configurados:', ''],
                [f'- CDs candidatos: {num_cds}', ''],
                [f'- Clientes: {num_clientes}', ''],
                [f'- CDs a abrir: Determinado pela otimização', ''],
            ]
    ...
    try:
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            instructions_data = [
                ...
                ['• 🎯 Objetivo do Modelo', 'Linha 13'],
                ['• 📝 Passo a Passo Detalhado', 'Linha 15'],
                ['• 📊 Exemplos Práticos Visuais', 'Linha 30'],
                ['• ✅ Checklist de Validação', 'Linha 43'],
                ['• ⚡ Dicas Rápidas', 'Linha 51'],
                ['• ❓ Perguntas Frequentes', 'Linha 59'],
                ['• 🛠️ Troubleshooting', 'Linha 71'],
                ['• 🚀 Próximos Passos', 'Linha 81'],
                ['', ''],
                ...
                ['3. MODO BINÁRIO (Opcional)', 'Se não tiver valores exatos, use 1 (coberto) ou 0 (não coberto). Defina raio=0 no sistema.'],
                ['', ''],
                ['🎨 GUIA VISUAL DAS CORES:', ''],
                ['AZUL ESCURO (Cabeçalho)', 'Títulos das colunas - não editar'],
                ['AZUL CLARO (Primeira coluna)', 'Nomes dos CDs e linha de demanda - não editar'],
                ...
                ['', ''],
                ['📊 EXEMPLO PRÁTICO - TABELA VISUAL:', ''],
                ['CD Cliente1 Cliente2 Cliente3 Demanda', ''],
                ['CD1_SP 15.0 8.5 25.0 0', ''],
                ['CD2_RJ 12.0 5.0 20.0 0', ''],
                ['Demanda 100 150 80', ''],
                ['', ''],
                ['💡 Valores acima:', f'{"Distâncias em km" if tipo_dado == "distancia" else "Custos em R$/unidade"}'],
                ['• Raio de cobertura:', f'{raio_cobertura} km'],
                ['• Clientes dentro do raio:', 'Considerados cobertos (1)'],
                ['• Clientes fora do raio:', 'Não cobertos (0)'],
                ['', ''],
                ...
                ['✅ CHECKLIST ANTES DO UPLOAD:', 'Marque itens conforme verifica'],
                ['□ Matriz completa (sem células vazias)', 'Verifique todas as células cinzas'],
                ['□ Valores não negativos', 'Use apenas números ≥ 0'],
                ['□ Raio adequado configurado', f'{raio_cobertura} km no sistema'],
                ['□ Demanda preenchida', 'Todos os clientes com demanda'],
                ['□ Coordenadas em formato decimal (se usadas)', 'Ex: -23.5505, -46.6333 ou -23,5505, -46,6333'],
                ['□ Arquivo salvo como .xlsx', 'Formato Excel correto'],
                ['', ''],
                ['⚡ DICAS RÁPIDAS - ATALHOS DO EXCEL:', ''],
                ...
                ['', ''],
                ['❓ PERGUNTAS FREQUENTES (FAQ):', ''],
                ['Q: O que é raio de cobertura?', f'A: Distância máxima de {raio_cobertura} km que um CD atende'],
                ['Q: Posso usar vírgula nos números?', f'A: Não, use apenas ponto decimal (15.5, não 15,5)'],
                ['Q: Como funciona modo binário?', 'A: Use 1 para cliente coberto, 0 para não coberto'],
                ['Q: Coordenadas são obrigatórias?', 'A: Não, mas recomendadas para mapas interativos'],
                ['Q: O que fazer se cobertura for baixa?', 'A: Aumente raio ou número de CDs'],
                ['', ''],
                ['📈 SEU PROGRESSO:', 'Status atual do preenchimento'],
                ['▓▓▓▓▓▓▓▓░ 90% - Quase pronto!', ''],
                ['✅ Dados básicos preenchidos', ''],
                ...
                ['📖 GLOSSÁRIO RÁPIDO:', 'Termos importantes'],
                ['CD: Centro de Distribuição', ''],
                ['Raio de Cobertura: Distância máxima de atendimento', ''],
                ['Demanda Ponderada: Clientes com maior demanda têm mais peso', ''],
                ['Matriz Binária: 1=coberto, 0=não coberto', ''],
                ['Cobertura: Percentual de clientes atendidos', ''],
                ['', ''],
                ['📊 MÉTRICAS ESPERADAS:', 'Resultados que você obterá'],
                ['• Cobertura máxima: Otimizada para seus dados', ''],
                ['• Tempo de processamento: < 2 min', 'Para resolver o problema'],
                ['• Precisão da solução: > 99%', 'Garantia de otimalidade'],
                ['• Relatórios gerados: 3 tipos', 'Mapas, estatísticas e recomendações'],
                ['', ''],
                ...
                ['• Latitude/Longitude', 'Use coordenadas decimais (ex: -23.5505, -46.6333 ou -23,5505, -46,6333)'],
                ...
                ['2. Use o checklist para validar (linha 38)', ''],
                ['3. (Opcional) Atualize coordenadas na aba "Coordenadas_CDs"', ''],
                ['4. Salve o arquivo Excel (.xlsx)', ''],
                ['5. Faça upload no sistema', ''],
                ['6. Aguarde o resultado da otimização', ''],
                ['7. Visualize mapas e relatórios nos resultados', ''],
                ['', ''],
                ['Parâmetros configurados:', ''],
                [f'- CDs candidatos: {num_cds}', ''],
                [f'- Clientes: {num_clientes}', ''],
                [f'- CDs a abrir: {p_cds}', ''],
                [f'- Raio de cobertura: {raio_cobertura} km', ''],
            ]
    ...
    try:
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            instructions_data = [
                ...
                ['• 🎯 Objetivo do Modelo', 'Linha 13'],
                ['• 📝 Passo a Passo Detalhado', 'Linha 15'],
                ['• 📊 Exemplos Práticos Visuais', 'Linha 28'],
                ['• ✅ Checklist de Validação', 'Linha 39'],
                ['• ⚡ Dicas Rápidas', 'Linha 47'],
                ['• ❓ Perguntas Frequentes', 'Linha 55'],
                ['• 🛠️ Troubleshooting', 'Linha 67'],
                ['• 🚀 Próximos Passos', 'Linha 77'],
                ['', ''],
                ...
                ['', ''],
                ['📊 EXEMPLO PRÁTICO - TABELA VISUAL:', ''],
                ['CD Cliente1 Cliente2 Cliente3', ''],
                ['CD1_SP 15.0 8.5 25.0', ''],
                ['CD2_RJ 12.0 5.0 20.0', ''],
                ['CD3_BH 18.0 10.0 14.0', ''],
                ['', ''],
                ['💡 Valores acima:', f'{"Distâncias em km" if tipo_dado == "distancia" else "Custos em R$/unidade"}'],
                ['• Maior distância: 25.0 km', ''],
                ['• Menor distância: 5.0 km', ''],
                ['• Sistema minimizará o máximo', ''],
                ['', ''],
                ['🌍 COORDENADAS DOS CDs (OPCIONAL):', ''],
                ['• Aba "Coordenadas_CDs"', 'Coordenadas geográficas reais dos CDs com design profissional'],
                ['• Layout Profissional', 'Cabeçalho azul escuro, bordas e alinhamento centralizado'],
                ...
                ['□ Matriz completa (sem células vazias)', 'Verifique todas as células cinzas'],
                ['□ Valores não negativos', 'Use apenas números ≥ 0'],
                ['□ Número correto de CDs', f'Exatamente {p_cds} CDs serão abertos'],
                ['□ Coordenadas em formato decimal (se usadas)', 'Ex: -23.5505, -46.6333 ou -23,5505, -46,6333'],
                ['□ Arquivo salvo como .xlsx', 'Formato Excel correto'],
                ['□ Sem formatação nos números', f'Ex: 15.5, não {"15,5 km" if tipo_dado == "distancia" else "R$ 15,50"}'],
                ['', ''],
                ['⚡ DICAS RÁPIDAS - ATALHOS DO EXCEL:', ''],
                ['• Copiar/Colar: Ctrl+Drag para células adjacentes', 'Preenche rapidamente'],
                ['• Validação: F5 > Especial > Constantes', 'Encontra células com erros'],
                ...
                ['', ''],
                ['❓ PERGUNTAS FREQUENTES (FAQ):', ''],
                ['Q: O que significa "minimizar a maior distância"?', 'A: Garantir que o cliente mais distante fique o mais próximo possível'],
                ['Q: Posso usar vírgula nos números?', f'A: Não, use apenas ponto decimal (15.5, não 15,5)'],
                ['Q: Por que não tem demanda?', 'A: Todos os clientes têm igual importância no modelo'],
                ['Q: Coordenadas são obrigatórias?', 'A: Não, mas recomendadas para mapas interativos'],
                ['Q: Ideal para que tipo de negócio?', 'A: Serviços emergenciais, segurança, entregas urgentes'],
                ['', ''],
                ['📈 SEU PROGRESSO:', 'Status atual do preenchimento'],
                ['▓▓▓▓▓▓▓▓░ 90% - Quase pronto!', ''],
                ['✅ Dados básicos preenchidos', ''],
                ...
                ['📖 GLOSSÁRIO RÁPIDO:', 'Termos importantes'],
                ['CD: Centro de Distribuição', ''],
                ['p-Centros: Problema de minimax', ''],
                ['Equidade: Todos os clientes tratados igualmente', ''],
                ['Matriz: Tabela de distâncias/custos', ''],
                ['Minimax: Minimizar o máximo valor', ''],
                ['', ''],
                ['📊 MÉTRICAS ESPERADAS:', 'Resultados que você obterá'],
                ['• Distância máxima minimizada', 'Otimizada para seus dados'],
                ['• Tempo de processamento: < 2 min', 'Para resolver o problema'],
                ['• Precisão da solução: > 99%', 'Garantia de otimalidade'],
                ['• Relatórios gerados: 3 tipos', 'Mapas, estatísticas e recomendações'],
                ['', ''],
                ...
                ['2. Use o checklist para validar (linha 34)', ''],
                ['3. (Opcional) Preencha coordenadas na aba "Coordenadas_CDs"', ''],
                ['4. Salve o arquivo Excel (.xlsx)', ''],
                ['5. Faça upload no sistema', ''],
                ['6. Aguarde o resultado da otimização', ''],
    ...
    try:
        ...
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            ...
            instructions_data = [
                ...
                ['2. DEMANDA DOS CLIENTES (Linha "Demanda Total")', 'Informe a demanda mensal (unidades) de cada cliente'],
                ['3. CUSTO FIXO E CAPACIDADE (Colunas finais)', 'Preencha se desejar considerar custos operacionais e limites de capacidade na análise'],
                ['', ''],
                ['🎨 GUIA VISUAL DAS CORES:', ''],
                ['AZUL ESCURO (Cabeçalho)', 'Títulos das colunas - não editar'],
                ['AZUL CLARO (Primeira coluna)', 'Nomes dos CDs e linha de demanda - não editar'],
                ...
                ['📊 EXEMPLO PRÁTICO - TABELA VISUAL:', ''],
                ['CD Cliente1 Cliente2 Cliente3 CustoFixo Capacidade', ''],
                ['CD1_SP 5.50 8.20 3.75 0 0', ''],
                ['CD2_RJ 7.30 4.10 6.85 0 0', ''],
                ['Demanda 300 450 250', ''],
                ['', ''],
                ['💡 Valores acima:', 'R$/unidade de transporte'],
                ['• Demanda pondera importância', 'Clientes com alta demanda têm mais peso'],
                ['• Custo fixo opcional', 'Use para análise de custos operacionais'],
                ['• Capacidade opcional', 'Use para análise de limites operacionais'],
                ['', ''],
                ['🌍 COORDENADAS DOS CDs (OPCIONAL):', ''],
                ['• Aba "Coordenadas_CDs"', 'Coordenadas geográficas reais dos CDs com design profissional'],
                ['• Layout Profissional', 'Cabeçalho azul escuro, bordas e alinhamento centralizado'],
                ...
                ['', ''],
                ['💡 CARACTERÍSTICAS DO P-MEDIANAS:', ''],
                ['• Foco em Demanda Ponderada', 'Clientes com maior demanda têm mais peso'],
                ['• Custo Fixo Opcional', 'Pode ser considerado para análise completa'],
                ['• Capacidade Opcional', 'Pode limitar atendimento se desejado'],
                ['• Número Fixo de CDs', f'Exatamente {p_cds} CDs serão abertos'],
                ['• Atendimento Exclusivo', 'Cada cliente é atendido por apenas 1 CD'],
                ['', ''],
                [' CHECKLIST ANTES DO UPLOAD:', 'Marque itens conforme verifica'],
                [' Matriz completa (sem células vazias)', 'Verifique todas as células cinzas'],
                [' Demanda não negativa', 'Use apenas números ≥ 0'],
                [' Número correto de CDs', f'Exatamente {p_cds} CDs serão abertos'],
                [' Custo fixo (se usado)', 'Valores ≥ 0 para análise de custos'],
                [' Capacidade (se usada)', 'Valores ≥ 0 e suficientes para demanda'],
                [' Coordenadas em formato decimal (se usadas)', 'Ex: -23.5505 ou -23,5505'],
                [' Arquivo salvo como .xlsx', 'Formato Excel correto'],
                [' Sem formatação nos números', 'Ex: 5.50 ou 5,50, não R$ 5,50'],
                ['', ''],
                [' DICAS RÁPIDAS - ATALHOS DO EXCEL:', ''],
                ['• Copiar/Colar: Ctrl+Drag para células adjacentes', 'Preenche rapidamente'],
                ['• Validação: F5 > Especial > Constantes', 'Encontra células com erros'],
                ...
                ['', ''],
                ['❓ PERGUNTAS FREQUENTES (FAQ):', ''],
                ['Q: O que significa "demanda ponderada"?', 'A: Clientes com maior demanda têm mais peso na otimização'],
                ['Q: Posso usar vírgula nos números?', 'A: Use ponto decimal (5.50) ou vírgula (5,50) nos dados'],
                ['Q: Custo fixo e capacidade são usados?', 'A: Sim, opcionalmente para análise completa de custos e limites'],
                ['Q: Coordenadas são obrigatórias?', 'A: Não, mas recomendadas para mapas interativos'],
                ['Q: Ideal para que tipo de negócio?', 'A: Distribuição logística, transporte, varejo, serviços'],
                ['', ''],
                ['📈 SEU PROGRESSO:', 'Status atual do preenchimento'],
                ['▓▓▓▓▓▓▓░ 90% - Quase pronto!', ''],
                ['✅ Dados básicos preenchidos', ''],
                ...
                ['📖 GLOSSÁRIO RÁPIDO:', 'Termos importantes'],
                ['CD: Centro de Distribuição', ''],
                ['p-Medianas: Problema de mediana ponderada', ''],
                ['Demanda Ponderada: Clientes com alta demanda têm mais peso', ''],
                ['Matriz: Tabela de custos/distâncias', ''],
                ['Mediana: Posição central ponderada', ''],
                ['', ''],
                ['📊 MÉTRICAS ESPERADAS:', 'Resultados que você obterá'],
                ['• Distância total minimizada', 'Otimizada para seus dados'],
                ['• Tempo de processamento: < 2 min', 'Para resolver o problema'],
                ['• Precisão da solução: > 99%', 'Garantia de otimalidade'],
                ['• Relatórios gerados: 3 tipos', 'Mapas, estatísticas e recomendações'],
                ['', ''],
